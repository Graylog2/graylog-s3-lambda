...
/**
 * {@link org.graylog2.gelfclient.GelfMessageBuilder} can be used to build one or more valid {@link GelfMessage}s.
 * <p>
 * Since the message properties are stored in the {@link org.graylog2.gelfclient.GelfMessageBuilder} instance, it
...
public class GelfMessageBuilder {
    ...
    /**
     * Construct a {@link org.graylog2.gelfclient.GelfMessageBuilder} instance with the given message.
     *
    ...
    /**
     * Construct a {@link org.graylog2.gelfclient.GelfMessageBuilder} instance with the given message and @{code host} field.
     *
     * @param message The message of the {@link GelfMessage}
     ...
     */
    public org.graylog2.gelfclient.GelfMessageBuilder message(final String message) {
        this.message = message;
        return this;
    }
     ...
     * @return {@code this} instance
     */
    public org.graylog2.gelfclient.GelfMessageBuilder fullMessage(final String fullMessage) {
     ...
     * @return {@code this} instance
     */
    public org.graylog2.gelfclient.GelfMessageBuilder timestamp(final double timestamp) {
     ...
     * @return {@code this} instance
     */
    public org.graylog2.gelfclient.GelfMessageBuilder timestamp(final long millis) {
     ...
     * @return {@code this} instance
     */
    public org.graylog2.gelfclient.GelfMessageBuilder level(final GelfMessageLevel level) {
        this.level = level;
        return this;
    }
     ...
     * @return {@code this} instance
     */
    public org.graylog2.gelfclient.GelfMessageBuilder additionalField(final String key, final Object value) {
     ...
     * @return {@code this} instance
     */
    public org.graylog2.gelfclient.GelfMessageBuilder additionalFields(final Map<String, Object> additionalFields) {
        fields.putAll(additionalFields);
        return this;
    }

    /**
     * Build a new {@link GelfMessage} with all information from the {@link org.graylog2.gelfclient.GelfMessageBuilder}.
     *
