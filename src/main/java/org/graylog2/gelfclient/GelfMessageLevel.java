...
public enum GelfMessageLevel {
    ...
    public static org.graylog2.gelfclient.GelfMessageLevel fromNumericLevel(final int level) {
        for (final org.graylog2.gelfclient.GelfMessageLevel gelfMessageLevel : values()) {
