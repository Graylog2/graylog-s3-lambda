...
public class CloudFlareLogsParserTest {
    ...
    public void testParsing() throws IOException {
        ...
        assertEquals(56, gelfMessage.getAdditionalFields().size());
